...
<div class="row">
    ...
    <div>
        <div>
            <br>
            <div>
                <h2 class="m-0" style="color:midnightblue">People that send you friend request</h2>
            </div>
            <br>
                        ...
                        <div class="boxSetting">
                            <div class='posts'>
                                <div class='photoUser' class="card-header border-bottom">
                                    <div class='imageUser'><img src="{{asset('storage/images/'.$user->avatar)}}" alt='User avatar' width="100" /></div>
                                </div>
                                <div class='postBox1'>
                            ...
                            <a href="{{ route('userProfile',['id'=>$user->user1_id] )}}">
